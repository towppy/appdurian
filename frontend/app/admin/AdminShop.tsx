    ...
    return (
        <View style={{ flex: 1, flexDirection: 'row', backgroundColor: Palette.linenWhite }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 40 }}>
                <Text style={{ fontSize: 32, fontFamily: Fonts.bold, color: Palette.charcoalEspresso }}>Shop Inventory</Text>
                <Text style={{ marginTop: 12, fontSize: 16, color: Palette.slate, fontFamily: Fonts.medium, textAlign: 'center' }}>
                    Update products, manage pricing, and track shipments for the marketplace.
                </Text>
            </View>
        </View>
    );
