...
const COLORS = {
  primary: Palette.warmCopper, // Warm Copper
  primaryDark: Palette.deepObsidian, // Deep Obsidian
  primaryLight: Palette.mutedSage, // Muted Sage
  accent: Palette.warmCopper,
  white: Palette.white,
  border: Palette.stoneGray, // Stone Gray
  black: '#000000',
  gray: Palette.slate,
  textDark: Palette.charcoalEspresso, // Charcoal Espresso
} as const;
